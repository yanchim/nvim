...
return {{"MunifTanjim/nui.nvim", lazy = true}, {"echasnovski/mini.icons", lazy = true, opts = {}, init = _1_}, {"rcarriga/nvim-notify", keys = {{"<Leader>vl", _3_, desc = "View logs"}, {"<Leader>un", _4_, desc = "Dismiss All Notifications"}}}, {"stevearc/dressing.nvim", opts = {}}, {"folke/noice.nvim", event = "VeryLazy", opts = {}, config = _5_}, {"nvim-lualine/lualine.nvim", config = _6_}}
