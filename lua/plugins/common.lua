...
local function _11_()
  ...
  return wk.register({["<leader>b"] = {name = "Buffer"}, ["<leader>c"] = {name = "Code"}, ["<leader>e"] = {name = "Explore"}, ["<leader>f"] = {name = "Find"}, ["<leader>g"] = {name = "Git", b = {name = "Buffer"}, h = {name = "Hunk"}, l = {name = "Line"}}, ["<leader>l"] = {name = "Lsp"}, ["<leader>s"] = {name = "Search"}, ["<leader>t"] = {name = "Toggle/Tab"}})
end
