...
vim.keymap.set("n", "<leader>th", _1_, {desc = "move tab left"})
local function _2_()
  return vim.cmd.tabmove("+")
end
vim.keymap.set("n", "<leader>tl", _2_, {desc = "move tab right"})
local function _3_()
  return vim.cmd.tabmove("0")
end
vim.keymap.set("n", "<leader>ta", _3_, {desc = "move tab first"})
local function _4_()
  return vim.cmd.tabmove("$")
end
vim.keymap.set("n", "<leader>te", _4_, {desc = "move tab last"})
